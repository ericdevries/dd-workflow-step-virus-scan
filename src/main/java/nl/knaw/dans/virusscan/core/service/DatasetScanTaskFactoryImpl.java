...
public class DatasetScanTaskFactoryImpl implements DatasetScanTaskFactory {
    ...
    public DatasetScanTaskFactoryImpl(DataverseApiService dataverseApiService, VirusScanner virusScanner, ExecutorService executorService) {
    ...
    public void startTask(PrePublishWorkflowPayload payload) {
        var task = new DatasetScanTask(dataverseApiService, virusScanner, payload);
